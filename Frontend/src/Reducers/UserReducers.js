...
export const User = (state = InitialUserState, action) => {
  switch (action.type) {
    ...
    case "UPDATEPROFILEIMG":
      return {
        ...state,
        userdata: { ...state.userdata, ProfilePicture: action.payload },
      };
    case "UPDATECOVERIMG":
      return {
        ...state,
        userdata: { ...state.userdata, CoverPicture: action.payload },
      };
    case "UPDATEBIO":
    ...
    case "EMAILVERIFIED":
      return {
        ...state,
        userdata: { ...state.userdata, isEmailVerified: true },
      };
    case "TOPFOLLOWED":
      return {
        ...state,
    ...
    case "UNFOLLOW":
      const newFollowing = state.userdata.Following.filter(
        (x) => x !== action.payload
      );
      return {
        ...state,
        userdata: { ...state.userdata, Following: newFollowing },
      };
    default:
      return { ...state };
  }
